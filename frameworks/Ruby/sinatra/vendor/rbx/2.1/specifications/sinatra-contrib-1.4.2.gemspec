...
Gem::Specification.new do |s|
  ...
  s.require_paths = ["lib"]
  s.authors = ["Konstantin Haase", "Gabriel Andretta", "Trevor Bramble", "Zachary Scott", "Katrina Owen", "Nicolas Sanguinetti", "Hrvoje \xC5\xA0imi\xC4\x87", "Masahiro Fujiwara", "Rafael Magana", "Jack Chu", "Ilya Shindyapin", "Kashyap", "Sumeet Singh", "lest", "Adrian Paca\xC5\x82a", "Aish", "Andrew Crump", "David Asabina", "Eliot Shepard", "Eric Marden", "Gray Manley", "Guillaume Bouteille", "Jamie Hodge", "Kyle Lacy", "Martin Frost", "Mathieu Allaire", "Matt Lyon", "Matthew Conway", "Meck", "Michi Huber", "Patricio Mac Adden", "Reed Lipman", "Samy Dindane", "Thibaut Sacreste", "Uchio KONDO", "Will Bailey", "undr"]
  s.date = "2013-12-01"
